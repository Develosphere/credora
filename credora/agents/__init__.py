...
# RAG agent imports moved to credora.rag package to avoid circular imports
# Use: from credora.rag import get_rag_agent, search_products, etc.
# Or for backward compatibility: from credora.agents.rag import get_rag_agent
...
__all__ = [
    ...
    "get_insight_agent",
    "INSIGHT_AGENT_INSTRUCTIONS",
    # RAG agent - Import from credora.rag package instead
    # "create_rag_agent",
    # "get_rag_agent",
    # "create_faiss_index",
