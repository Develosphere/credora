...
Campaigns: {len(campaigns)}"""
    ...
    # All supported platforms should be handled by MCP servers
    return f"Error: Platform '{platform_lower}' is not supported. Supported platforms: {', '.join(MCP_PLATFORMS)}"
...
{status_breakdown if status_breakdown else "  No orders found"}"""
    ...
    # All supported platforms should be handled by MCP servers
    return f"Error: Platform '{platform_lower}' is not supported for orders. Supported: shopify"
...
Active Products: {active_count}"""
    ...
    # All supported platforms should be handled by MCP servers
    return f"Error: Platform '{platform_lower}' is not supported for products. Supported: shopify"
...
Customer segment: {segment}"""
    ...
    # All supported platforms should be handled by MCP servers
    return f"Error: Platform '{platform_lower}' is not supported for customers. Supported: shopify"


# Decorated tools for agent use
@function_tool
def fetch_sales_data(user_id: str, platform: str, date_range: str = "30d") -> str:
    """Fetch sales metrics from a connected platform.
    ...
    Args:
        user_id: The unique identifier for the user
        platform: The platform (shopify, meta, google)
        date_range: Time period for data (7d, 30d, 90d, 1y, all)
