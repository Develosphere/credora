    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <div className="flex gap-4">
          <label className="flex items-center cursor-pointer">
            ...
            />
            <span className="ml-2 text-sm text-gray-300">Increase Prices</span>
          </label>
          <label className="flex items-center cursor-pointer">
            <input
              type="radio"
              ...
              className="h-4 w-4 text-credora-orange bg-[#0f0f0f] focus:ring-credora-orange/30"
            />
            <span className="ml-2 text-sm text-gray-300">Decrease Prices</span>
          </label>
        </div>
      </div>
      ...
      <div className="bg-[#0f0f0f] rounded-xl p-4">
        <div className="flex items-center gap-2 text-sm text-gray-400">
          <TrendingUp className="h-4 w-4 text-credora-orange" />
          <span>
            {changeType === "increase" ? "Increase" : "Decrease"} prices by{" "}
            <strong className="text-white">{changePercent}%</strong> for{" "}
